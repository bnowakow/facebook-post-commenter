...
//        takeScreenshot("trying_to_click_on_login_button")
        ...
        // TODO detect captcha and wait for input from console that captcha has been solved
        // DEBUG line below breakpoint for captcha
        Thread.sleep(6000)
    }
    ...
    fun switchProfileToFanPage() {
        ...
        if (facebookProperties.getProperty("username").contains("kuba")) {
            ...
            clickElementIfOneInListExists(listOf(
                ...
                "/html/body/div[1]/div/div/div[1]/div/div[2]/div[5]/div[1]/span/div/div[1]",
            ))
            ...
            clickElementIfOneInListExists(listOf(
                ...
                "/html/body/div[1]/div/div[1]/div/div[2]/div[5]/div[2]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div[1]/div/div/div[1]/div[1]/div/div/div[1]/div/span/div/div/div/div",
                "/html/body/div[1]/div/div/div[1]/div/div[2]/div[5]/div[2]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div[1]/div/div/div[1]/div[1]/div/div/div[1]/div/span/div/div/div/div",
                    ...
                    try {
                        clickElementIfOneInListExists(
                            listOf(
                                ...
                                "/html/body/div[1]/div/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div/div/div/div/div[13]/div/div/div[5]/div/div/div[2]/div[2]/div/div",
                            ), true
                        )
                        ...
                        clickElementIfOneInListExists(
                            listOf(
                                ...
                                "/html/body/div[1]/div/div/div[1]/div/div[3]/div/div/div[2]/div/div/div[1]/div[1]/div/div/div/div/div/div/div[1]/div/div[4]",
                            ), true
                        )
                        Thread.sleep(5000)
                    } catch (e: Exception) {
                ...
                if (indexOfSharedPostsHeading!! > -1) {
                            ...
                            when (it) {
                                ...
                                SharedPostStrategy.USE_SHARED_ENDPOINT -> clickElementIfOneInListExists(
                                    listOf(
                                        ...
                                        "/html/body/div[1]/div/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[1]/div/div/div/div/div/div/div/div/div/div[13]/div/div/div[4]/div/div/div[1]/div/div/div/div[1]/div[1]",
                    ...
                    if (it == SharedPostStrategy.CLICK_ON_SHARED_POSTS ||
                        ...
                        pageSource = pageSource
                            ...
                            .substringAfter("href=\"https://www.siepomaga")
                                    ...
                                    commentTextFieldPossibleXpaths = when (it) {
                                        ...
                                        SharedPostStrategy.USE_SHARED_ENDPOINT -> clickElementIfOneInListExists(
                                                listOf(
                                                    ...
                                                    "/html/body/div[1]/div/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[$postNumber]/div/div/div/div/div/div/div/div[1]/div/div[13]/div/div/div[4]/div/div/div[2]/div[3]/div[2]/div/div/div/div/div[2]/div/div[2]/form/div/div/div[1]/div/div[1]/div/div[1]",
                                                    "/html/body/div[1]/div/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[$postNumber]/div/div/div/div/div/div/div/div/div/div[13]/div/div/div[4]/div/div/div[2]/div[3]/div[2]/div/div/div/div/div/div/div[2]/form/div/div/div[1]/div/div[1]/div/div[1]",
                                                    ...
                                                    "/html/body/div[1]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[${postNumber}]/div/div/div/div/div/div/div/div[1]/div/div[13]/div/div/div[4]/div/div/div[2]/div[3]/div[1]/div/div/div/div/div[2]/div/div[2]/form/div/div[1]/div[1]/div/div[1]/div/div[1]",
                                                    "/html/body/div[1]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[${postNumber}]/div/div/div/div/div/div/div/div/div/div[13]/div/div/div[4]/div/div/div[2]/div[3]/div[1]/div/div/div/div/div[2]/div/div[2]/form/div/div[1]/div[1]/div/div[1]/div/div[2]",
                                                    "/html/body/div[1]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[${postNumber}]/div/div/div/div/div/div/div/div/div/div[13]/div/div/div[4]/div/div/div[2]/div[3]/div[1]/div/div/div/div/div/div/div[2]/form/div/div/div[1]/div/div[1]/div/div[1]",
                                                ), false
                                            )
